...
const messages: Record<Language, Record<string, string>> = {
  vi: {
    ...
    "report.title": "Gửi yêu cầu cứu hộ", "report.subtitle": "Chỉ cần mô tả tình huống. Báo cáo vẫn được lưu khi mất Internet.", "report.aiHint": "AI sẽ phân tích nội dung để gợi ý số người, trẻ em, thương tích, nguy cơ và mực nước. Điều phối viên vẫn xác minh trước khi giao đội.",
  ...
  en: {
    ...
    "report.title": "Send a rescue request", "report.subtitle": "Describe the situation in one message. Your report remains saved when the Internet is unavailable.", "report.aiHint": "AI analyzes the message to suggest people at risk, children, injuries, hazards, and water level. An operator still verifies before dispatch.",
  ...
  ko: {
    ...
    "report.title": "구조 요청 보내기", "report.subtitle": "상황을 한 문장으로 설명하세요. 인터넷이 끊겨도 신고는 기기에 저장됩니다.", "report.aiHint": "AI가 메시지에서 인원, 어린이, 부상, 위험 및 수위를 제안합니다. 배정 전에는 운영자가 반드시 확인합니다.",
