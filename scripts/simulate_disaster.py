...
def reports() -> list[dict]:
    ...
    base = [
        {"source": "CALL_112", "message": "112 báo có 5 người, 2 trẻ em mắc kẹt gần Thôn 3, Xã Trà Linh, nước lên nhanh.", "address": "Thôn 3, Xã Trà Linh, thành phố Đà Nẵng", "latitude": 15.0232, "longitude": 108.0409, "number_of_people": 5, "number_of_children": 2, "is_trapped": True, "water_level": 2.2},
        {"source": "SMS", "message": "Cứu với, nhà gần Thôn 3 Trà Linh có 5 nguoi va 2 tre em, nuoc dang len, khong ra duoc.", "address": "Thôn 3, Xã Trà Linh, thành phố Đà Nẵng", "latitude": 15.0238, "longitude": 108.0414, "number_of_people": 5, "number_of_children": 2, "is_trapped": True, "water_level": 2.1},
        {"source": "LOCAL_OFFICER", "message": "Cán bộ xã xác nhận một hộ gần Thôn 3, Xã Trà Linh bị cô lập, có trẻ nhỏ.", "address": "Thôn 3, Xã Trà Linh, thành phố Đà Nẵng", "latitude": 15.0230, "longitude": 108.0408, "number_of_people": 5, "number_of_children": 2, "is_trapped": True, "water_level": 2.3},
